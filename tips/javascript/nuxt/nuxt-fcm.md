# Nuxt で Firebase Cloud Messaging（FCM）を使って Push 通知を実装する
...
[Safari で動かない](https://caniuse.com/push-api) ことが致命的な Push API ですが、Android や Chrome（フォアグラウンドだと通知こないけど）のユーザーに鮮度の高いメディア UX
